...
public class SwipeBackLayout extends FrameLayout {
   ...
   */
  public static final int EDGE_LEFT = com.droid.wiz.toolkits.swipeback.ViewDragHelper.EDGE_LEFT;

  /**
   * Edge flag indicating that the right edge should be affected.
   */
  public static final int EDGE_RIGHT = com.droid.wiz.toolkits.swipeback.ViewDragHelper.EDGE_RIGHT;

  /**
   * Edge flag indicating that the bottom edge should be affected.
   */
  public static final int EDGE_BOTTOM = com.droid.wiz.toolkits.swipeback.ViewDragHelper.EDGE_BOTTOM;
   ...
   * fling/snap.
   */
  public static final int STATE_IDLE = com.droid.wiz.toolkits.swipeback.ViewDragHelper.STATE_IDLE;

  /**
   * A view is currently being dragged. The position is currently changing as
   * a result of user input or simulated user input.
   */
  public static final int STATE_DRAGGING = com.droid.wiz.toolkits.swipeback.ViewDragHelper.STATE_DRAGGING;

  /**
   * A view is currently settling into place as a result of a fling or
   * predefined non-interactive motion.
   */
  public static final int STATE_SETTLING = com.droid.wiz.toolkits.swipeback.ViewDragHelper.STATE_SETTLING;
  ...
  private com.droid.wiz.toolkits.swipeback.ViewDragHelper mDragHelper;
  ...
  public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs);
    mDragHelper = com.droid.wiz.toolkits.swipeback.ViewDragHelper.create(this, new ViewDragCallback());
   ...
   * callback's
   * {@link com.droid.wiz.toolkits.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
   * and
   * {@link com.droid.wiz.toolkits.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
  ...
  protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
    ...
    if (mScrimOpacity > 0 && drawContent &&
        mDragHelper.getViewDragState() != com.droid.wiz.toolkits.swipeback.ViewDragHelper.STATE_IDLE) {
  ...
  private class ViewDragCallback extends com.droid.wiz.toolkits.swipeback.ViewDragHelper.Callback {
    ...
    public boolean tryCaptureView(View view, int i) {
      ...
      if (mEdgeFlag == EDGE_LEFT || mEdgeFlag == EDGE_RIGHT) {
        directionCheck = !mDragHelper.checkTouchSlop(com.droid.wiz.toolkits.swipeback.ViewDragHelper.DIRECTION_VERTICAL, i);
    ...
    public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
      ...
      if ((mTrackingEdge & EDGE_LEFT) != 0) {
        ...
        mScrollPercent =
            Math.abs((float) top / (mContentView.getHeight() + mShadowBottom.getIntrinsicHeight()));
      }
      mContentLeft = left;
      mContentTop = top;
      invalidate();
      ...
      if (mListeners != null && !mListeners.isEmpty() &&
          mDragHelper.getViewDragState() == STATE_DRAGGING && mScrollPercent >= mScrollThreshold &&
          mIsScrollOverValid) {
