...
public class CircularProgressView extends View {
  ...
  public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mBorderWidth = a.getDimension(R.styleable.CircularProgressView_borderWidth,
  ...
  private Property<CircularProgressView, Float> mAngleProperty =
      new Property<CircularProgressView, Float>(Float.class, "angle") {
        @Override
  ...
  private Property<CircularProgressView, Float> mSweepProperty =
      new Property<CircularProgressView, Float>(Float.class, "arc") {
        @Override
        public Float get(CircularProgressView object) {
